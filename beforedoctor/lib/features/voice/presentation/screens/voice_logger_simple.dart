...
class VoiceLoggerSimpleScreen extends StatefulWidget {
  const VoiceLoggerSimpleScreen({Key? key}) : super(key: key);

  @override
  State<VoiceLoggerSimpleScreen> createState() => _VoiceLoggerSimpleScreenState();
}

class _VoiceLoggerSimpleScreenState extends State<VoiceLoggerSimpleScreen> {
  ...
  Future<void> _processSymptom(String symptom) async {
    ...
    try {
      ...
      // Speak the result using simple TTS
      await _ttsService.speak(llmResponse);
