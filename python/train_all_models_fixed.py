#!/usr/bin/env python3
"""
Complete AI Model Training for BeforeDoctor (Fixed)
Trains all models using available datasets
"""
...
class CompleteModelTrainer:
    ...
    def load_comprehensive_dataset(self):
        ...
        try:
            ...
            if isinstance(data, dict):
                # If it's a dictionary, look for records or data key
                if 'records' in data:
            ...
            print(f"Loaded comprehensive dataset with {len(records)} records")
            return records
    ...
    def train_symptom_classifier(self):
        ...
        for record in data[:1000]:  # Use first 1000 records for training
            if isinstance(record, dict) and 'symptom' in record and record['symptom']:
...
'''
    ...
    def train_all_models(self):
        """Train all models"""
        print("Starting Complete AI Model Training")
        print("=" * 50)
